...
\usepackage[pagebackref=false]{hyperref} % For clickable links.
...
%\title{The Effect of DNS on Tor's Anonymity$^{\textdagger}$}
\title{The Effect of DNS on Tor's Anonymity\textsuperscript{\textdagger} (abstract)}
%
\author{
...
%\input{abstract}
%
\blfootnote{\textsuperscript{\textdagger}This paper will appear in NDSS 2017.}%~\cite{greschbach2016effect}}
%
