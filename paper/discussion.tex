...
\fixme{WF+DNS: fix bug + increase min TTL for the DNS cache at exits.}
...
\fixme{WF defense strong enough to kill recall of agressive WF attacks, since
WF+DNS gives high precision.}
