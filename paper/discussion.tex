...
to avoid. (To make matters worse, Fifield \ea's~\cite{Fifield2015a}
censorship circumvention system meek used Google's cloud infrastructure
...
Next, let us imagine a Tor network that only uses local resolvers.  In
