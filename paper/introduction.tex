...
\fixme{We don't create a new WF attack, we show how to use one when the
attacker can also observe DNS.}
...
\begin{itemize}
	...
	\item We present a novel website fingerprinting attack.  We augment our
		...
		adversary to reduce the open world scenario.\fixme{rephrase}
