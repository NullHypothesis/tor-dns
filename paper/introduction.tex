...
are a reality, and even smaller adversaries are a concern~\cite{Johnson2013a}.
A sound understanding of semi-global adversaries is necessary to better protect
Tor users and mitigate attacks.
...
results.  \fixme{We don't create a new WF attack, we show how to use one when
the attacker can also observe DNS.}  We evaluate our website fingerprinting
...
of DNS in Section~\ref{sec:landscape}.  \fixme{Add remaining sections once they
are done.}
