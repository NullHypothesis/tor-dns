...
existing website fingerprinting attacks can be improved by augmenting them with
DNS requests, we \third analyze the Internet-scale impact of our attack on Tor
...
snoop on Tor traffic.  \fixme{Add insights about WF attack and TorPS
simulations.}  Finally, some of our findings generalize to other anonymity
networks.
\end{abstract}
