...
\usepackage[cmex10]{amsmath} % For reasonable rendering of math symbols.
\usepackage[tight,footnotesize]{subfigure}

\definecolor{darkblue}{rgb}{0,0,0.5}
\hypersetup{
	pdftitle={Traffic correlation attacks using DNS},
	pdfauthor={Anonymous},
...
\title{Traffic correlation attacks using DNS}
