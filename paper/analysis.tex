...
\caption{The recall and precision when varying the starting Alexa rank.}
\label{fig:fpt:alexa}
\end{figure}
...
\caption{Effect of the Tor network scaling for Alexa ranks 10k and 100k.}
...
\subfigure[Effect of the Tor network scaling for Alexa ranks 10k and 100k.]{
