...
\centering
\subfigure[Recall]{
	\includegraphics[width=0.8\linewidth]{figures/fpt/alexa/1kx100+100k-recall-ggplot2}
    \label{fig:fpt:alexa:recall}
}
\subfigure[Precision]{
	\includegraphics[width=0.8\linewidth]{figures/fpt/alexa/1kx100+100k-precision-ggplot2}
