...
\centering
\subfigure[Recall]{
	\includegraphics[width=0.8\linewidth]{figures/fpt/pct/1kx100+100k-recall}
    \label{fig:fpt:torpct:recall}
}
\subfigure[Precision]{
	\includegraphics[width=0.8\linewidth]{figures/fpt/pct/1kx100+100k-precision}
...
\centering
\subfigure[Recall]{
	\includegraphics[width=0.8\linewidth]{figures/fpt/alexa/1kx100+100k-offsets-100pct-recall}
    \label{fig:fpt:alexa:recall}
}
\subfigure[Precision]{
	\includegraphics[width=0.8\linewidth]{figures/fpt/alexa/1kx100+100k-offsets-100pct-precision}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.75\linewidth]{figures/fpt/rounds/1kx100+100k}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.75\linewidth]{figures/fpt/window/1kx100+100k}
...
\begin{figure}[t]
\centering
	\includegraphics[width=0.75\linewidth]{figures/fpt/scale/1kx100+100k}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.75\linewidth]{figures/fpt/dist/1kx100+100k}
