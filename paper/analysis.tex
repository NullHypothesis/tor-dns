...
Whem monitoring 1,000 sites starting at rank 1, sites
...
\centering
\subfigure[Recall]{
	\includegraphics[width=0.8\linewidth]{figures/fpt/pct/1kx100+100k-recall-ggplot2}
    \label{fig:fpt:torpct:recall}
}
\subfigure[Precision]{
	\includegraphics[width=0.8\linewidth]{figures/fpt/pct/1kx100+100k-precision-ggplot2}
    \label{fig:fpt:torpct:precision}
}
...
\centering
\subfigure[Recall]{
	\includegraphics[width=0.465\linewidth]{figures/fpt/alexa/1kx100+100k-offsets-100pct-recall-ggplot2}
    \label{fig:fpt:alexa:recall}
}
\subfigure[Precision]{
	\includegraphics[width=0.465\linewidth]{figures/fpt/alexa/1kx100+100k-offsets-100pct-precision-ggplot2}
    \label{fig:fpt:alexa:precision}
}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.75\linewidth]{figures/fpt/rounds/1kx100+100k-ggplot2}
...
\begin{figure*}[t]
\centering
\subfigure[Effect of increasing the analysis time window.]{
    \includegraphics[width=0.31\linewidth]{figures/fpt/window/1kx100+100k-ggplot2}
    \label{fig:fpt:var:window}
}
\subfigure[Effect of Tor network size.]{
    \includegraphics[width=0.31\linewidth]{figures/fpt/scale/1kx100+100k-ggplot2}
    \label{fig:fpt:var:scale}
}
\subfigure[Effect of different website popularity distributions.]{
    \includegraphics[width=0.31\linewidth]{figures/fpt/dist/1kx100+100k-ggplot2}
...
\begin{figure}[t]
\centering
\subfigure[Effect of website fingerprinting defenses.]{
	\includegraphics[width=0.75\linewidth]{figures/fpt/rounds/1kx100+100k-ggplot2}
    \label{fig:fpt:var:rounds}
}
\subfigure[Effect of increasing the analysis time window.]{
	\includegraphics[width=0.75\linewidth]{figures/fpt/window/1kx100+100k-ggplot2}
    \label{fig:fpt:var:window}
}
\subfigure[Effect of Tor network size.]{
	\includegraphics[width=0.75\linewidth]{figures/fpt/scale/1kx100+100k-ggplot2}
    \label{fig:fpt:var:scale}
}
\subfigure[Effect of different website popularity distributions.]{
	\includegraphics[width=0.75\linewidth]{figures/fpt/dist/1kx100+100k-ggplot2}
    \label{fig:fpt:var:dist}
}
...
\begin{table}[t]
\caption{Mean and median DNS TTL values across Alexa top one million sites. Raw
...
only considers the unique domains with the minimum TTL for each website.}
\label{tab:ttls}
\centering
\begin{tabular}{l r r}
\toprule
