...
\centering
\subfigure[Recall]{
	\includegraphics[width=0.75\linewidth]{figures/fpt/pct/1kx100+100k-recall-ggplot2}
    \label{fig:fpt:torpct:recall}
}
\subfigure[Precision]{
	\includegraphics[width=0.75\linewidth]{figures/fpt/pct/1kx100+100k-precision-ggplot2}
...
\centering
\subfigure[Recall]{
	\includegraphics[width=0.8\linewidth]{figures/fpt/alexa/1kx100+100k-offsets-100pct-recall-ggplot2}
    \label{fig:fpt:alexa:recall}
}
\subfigure[Precision]{
	\includegraphics[width=0.8\linewidth]{figures/fpt/alexa/1kx100+100k-offsets-100pct-precision-ggplot2}
