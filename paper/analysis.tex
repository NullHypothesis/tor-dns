...
\centering
\subfigure[Recall]{
	\includegraphics[width=0.466\linewidth]{figures/wfdns/offsets/100x100+10k-offsets-100pct-recall}
    \label{fig:wfdns:offsets:recall}
}
\subfigure[Precision]{
	\includegraphics[width=0.466\linewidth]{figures/wfdns/offsets/100x100+10k-offsets-100pct-precision}
