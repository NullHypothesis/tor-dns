...
take caching of DNS requests into account. We ignore client-side DNS
caching\footnote{The Tor browser, built on Mozilla Firefox, caches up to
		...
		also maintains a local DNS cache \fixme{Does it respect TTLs or
				does it do clipping? is it activated by default?
