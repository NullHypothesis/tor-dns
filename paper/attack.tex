...
has visited.  This is not possible for domains such as YouTube, simply because
many websites embed YouTube videos.  Figure~\ref{fig:unique-domains} shows the
fraction of sites with unique domains for websites up to Alexa top one million.
For 96.8\% of all sites on the Alexa top one million there exists at least one
unique domain.  Interestingly, more popular websites are less likely to have a
unique domain associated with them: 43\% of Alexa's top 100 have a unique domain
compared to 96.8\% for the top one million. After Alexa's top 100, the fraction
is erratic between 27\% to 41\%---why is not apparent---but for less popular
sites from Alexa 100 and downwards the trend is clear.
