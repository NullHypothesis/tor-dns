...
\section{Replicating TorPS Simulations}
There are two main components you need in order to recreate the work of Section VII: 
\first~TorPS and \second~traceroutes between clients and Tor guards and between Tor 
exits and destinations.

The command I used to run TorPS was 
\begin{lstlisting}
...
This was after following the instructions in the TorPS readme on their website. 
