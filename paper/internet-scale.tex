...
different DNS configurations for five client ASes and to get estimates for 
the amount of time it would take for a compromise to take under the different 
DNS configurations in order to understand which DNS configuration 
might be more favorable for Tor exit relays. 
