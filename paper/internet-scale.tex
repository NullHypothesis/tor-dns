...
For Tor exits that rely on a 3rd-party for DNS resolution, a good position for an AS 
...
pessimistic in this respect. \fixme{Mention that these results apply only to what we had data for: about 
half.}
